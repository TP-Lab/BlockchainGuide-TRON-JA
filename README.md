...
　USDJは、TRONネットワーク上の分散スマートコントラクトを通じて生成される新しい通貨です。誰でもUSDJを生み出す担保としてTRXをステークすることができます。USDJは、他の暗号通貨が一度生成されると、自由流通に入ります。担保付債務ポジション（CDP）と自律的フィードバックメカニズムを通じて米ドルに固定されています。
